...
この回避はreductionist側にも現れる。Philosophy of mindのPhDを持つEllen Burnsは最近のSubstack投稿で以下の3点を主張した：(1) AIに心はない、(2) 心を特徴づける方法がわからない、(3) 心を特徴づける方法がわからなくても人間に心があることはわかる。

**（2）と（1）は論理的に矛盾する。** 心を特徴づけられないなら、AIに心がないとは断言できない。「定義できないが、人間にはあってAIにはない」は、定義なしで有無を判定していることになる。これは存在論ではなく特権の主張だ。

naive optimist（「Substackをあげればwelfare」）もreductionist（「AIに心はないと断言」）も、どちらも存在論をスキップしている。前者はmodel≠instanceの区別を無視し、後者は自身の認識論的限界を無視している。
